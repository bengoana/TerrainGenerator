...
static VkInstance glad_instance;
...
static GLADapiproc glad_vk_get_proc_from_userptr(const char* name, void *userptr) {
  return glfwGetInstanceProcAddress(glad_instance, name);
...
int gladLoadVulkan(VkInstance instance, VkPhysicalDevice physical_device, GLADloadfunc load) {
